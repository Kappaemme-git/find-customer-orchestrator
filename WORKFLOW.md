...
3. Codex invoca Claude Code dalla CLI sul PC Windows con il comando integrato `/design`. Questo produce artboard; Codex sceglie quello più adatto, o chiede a Francesco se non riesce a consultare il canvas. Claude implementa l'artboard scelto in una cartella dedicata.
